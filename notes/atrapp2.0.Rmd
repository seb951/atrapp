...
* XYZ Genes show changes in allele frequencies during the bloom in at least one of the sampling site, showing a highly dynamic evolution of the system. 19 genes show repeatable changes in allele frequencies in all three sampling sites. These represent good candidates to predict bloom.

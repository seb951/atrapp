...
^1.^Energy Mining and Environment, National Research Council Canada, Montreal, QC, Canada  
^2.^
^3.^Institut de Recherche en Biologie Végétale, Université de Montréal, Montréal, Québec, Canada  
^4.^Department of Biological Sciences, Université de Montréal, Montreal, Quebec, H3T 1J4, Canada    

## Abstract


Specific environmental conditions, such as elevated levels of nutrients from human activities, warmer temperatures, still water, and sunlight promote the growth of cyanobacteria, which at high density, form cyanobacterial algae blooms. Each summer, cyanobacteria make an appearance in Lake Champlain and pose health risks to humans and animals due to the production of cyanotoxins. Here, we used a metatranscriptomics approach that targets genes expressed in the water to identify changes in the bacterial community during the summer. At the height of the bloom (mid-September) were chlorophyll A increased by nearly 100 fold, communities were dominated by the cyanobacteria *Dolichospermum circinale* and to a lesser extent *Microcystis aeruginosa*. We then identified 19 genes that changed in allele (SNPs) frequency from the beginning to the end of the bloom. These represent candidate genes that can help to predict blooms in the future.

## Introduction
* Specific environmental conditions, such as elevated levels of nutrients from human activities (e.g. N and P), warmer temperatures, still water, and sunlight promote the growth of cyanobacteria. At high density, these form **cyanobacterial blooms**. 
* Each summer, cyanobacteria algae blooms make an appearance in Lake Champlain and pose health risks to humans and animals due to the production of cyanotoxins.
...
* Identify the *Dolichospermum* (main bloom causing cyanobacteria) genes that change in allele (SNPs) frequency from the beginning to the end of the bloom. These represent candidate genes that can help to predict blooms in the future.
...
6. *Dolichospermum* sequences aligned to transcriptome using bowtie2 [@langmead2012fast]. SNP were called using SAMtools [@li2009sequence].
7. Changes in allele frequency quantified using logistic regressions in R.  
8. Candidate genes showing significant changes in allele frequency BLASTed and compared against reference transcriptome.  

## Results 
![](../figures/chloro.png){width=300px}
...
![](../results/dolicho/figures/Champlain_genera_barplot.png){width=700px}

&nbsp;

 **Figure 3: Communities dominated by *Fusobacterium* & *Acinetobacter* prior to bloom. During Bloom, *Dolichospermum circinale* rose in frequency, followed to a lesser extent by *Microcystis aeruginosa* in September.**
...
![](../results/dolicho/figures/venn_figure.png){width=700px}
&nbsp;

**Figure 4: A. Number of SNPs (genes) showing significant changes in allele frequency from beginning (June 1st) to end of bloom (October 6th). B. Example of a significant SNP in both St1, St2 (logistic regressions) and PRM (linear regression) sites (Total: 22 SNPs, 19 SNPs). C. Gene ontology groups for candidates (no significant over-represented groups compared to reference transcriptome)**
...
## Conclusions
* Metatranscriptomics can identify cyanobacterial blooms.
* Genes that show changes in allele frequencies during the bloom season represent good candidates to predict bloom.
* Further sampling and sequencing in progress in other lakes to confirm patterns.

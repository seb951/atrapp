...
Each summer, cyanobacteria make an appearance in Lake Champlain (Baie Missisquoi) and pose health risks to humans and animals due to the production of cyanotoxins. 
...
* Identify *Dolichospermum* (main bloom causing cyanobacteria) genes that change in allele (SNPs) frequency from the beginning to the end of the bloom. 


## Method
1. Water sampled at three location in Lake Champlain (**see Figure 1**) during the cyanobacterial bloom in the summer of 2016 (June 1st - October 10th).
2. RNA extracted, followed by High Throughput sequencing (100bp paired end Illumina HiSeq).
3. Metatranscriptomes processed using SAMSA2 pipeline (trimming, merging, removal of rRNA, annotation) [@westreich2018samsa2].
...
6. Changes in allele frequency quantified using regressions (logistic for St1 & St2, linear for PRM).
